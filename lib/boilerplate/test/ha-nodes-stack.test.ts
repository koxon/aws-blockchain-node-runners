...
import {
    TEST_STACKS_DATA_VOL_IOPS,
    TEST_STACKS_DATA_VOL_SIZE,
    TEST_STACKS_DATA_VOL_THROUGHPUT,
    TEST_STACKS_DATA_VOL_TYPE,
    TEST_STACKS_INSTANCE_TYPE,
    TEST_STACKS_P2P_PORT,
    TEST_STACKS_RPC_PORT,
} from "./test-constants";
