...
export interface MyChainHANodesStackProps extends cdk.StackProps {
...
export class MyChainHANodesStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: MyChainHANodesStackProps) {
