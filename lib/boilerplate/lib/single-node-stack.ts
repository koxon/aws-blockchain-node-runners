...
import * as configTypes from "./config/mychainConfig.interface";
import * as constants from "../../constructs/constants";
import { MyChainNodeSecurityGroupConstruct } from "./constructs/mychain-node-security-group"

export interface MyChainSingleNodeStackProps extends cdk.StackProps {
    instanceType: ec2.InstanceType;
    instanceCpuType: ec2.AmazonLinuxCpuType;
    mychainCluster: configTypes.MyChainCluster;
    mychainRpcPort: configTypes.MyChainRpcPort;
    mychainVersion: string;
    nodeConfiguration: configTypes.MyChainNodeConfiguration;
    dataVolume: configTypes.MyChainDataVolumeConfig;
    accountsVolume: configTypes.MyChainAccountsVolumeConfig;
...
export class MyChainSingleNodeStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: MyChainSingleNodeStackProps) {
        ...
        // Setting up the security group for the node from MyChain-specific construct
        const instanceSG = new MyChainNodeSecurityGroupConstruct (this, "security-group", {
            vpc: vpc,
        ...
        const importedInstanceRoleArn = cdk.Fn.importValue("MyChainNodeInstanceRoleArn");
        ...
        const modifiedInitNodeScript = cdk.Fn.sub(nodeStartScript, {
            ...
            _MYCHAIN_VERSION_: mychainVersion,
            _MYCHAIN_NODE_TYPE_: nodeConfiguration,
            _NODE_IDENTITY_SECRET_ARN_: mychainNodeIdentitySecretARN,
            ...
            _MYCHAIN_CLUSTER_: mychainCluster,
        ...
        new cw.CfnDashboard(this, 'mychain-cw-dashboard', {
