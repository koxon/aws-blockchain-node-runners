...
export interface MyChainCommonStackProps extends cdk.StackProps {

}

export class MyChainCommonStack extends cdk.Stack {
    AWS_STACKNAME = cdk.Stack.of(this).stackName;
    AWS_ACCOUNT_ID = cdk.Stack.of(this).account;

    constructor(scope: cdkConstructs.Construct, id: string, props: MyChainCommonStackProps) {
        ...
        instanceRole.addToPolicy(new iam.PolicyStatement({
           resources: [`arn:aws:autoscaling:${region}:${this.AWS_ACCOUNT_ID}:autoScalingGroup:*:autoScalingGroupName/mychain-*`],
           actions: ["autoscaling:CompleteLifecycleAction"],
          }));

        new cdk.CfnOutput(this, "Instance Role ARN", {
            value: instanceRole.roleArn,
            exportName: "MyChainNodeInstanceRoleArn",
        });
