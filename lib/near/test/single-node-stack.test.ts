...
describe("NearSingleNodeStack", () => {
  test("synthesizes the way we expect", () => {
    ...
    // Create the NearSingleNodeStack.
    const nearSingleNodeStack = new NearSingleNodeStack(app, "near-sync-node", {
    ...
    const template = Template.fromStack(nearSingleNodeStack);
