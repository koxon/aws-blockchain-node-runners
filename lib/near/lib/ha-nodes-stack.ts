...
import * as configTypes from "./config/nearConfig.interface";
...
export interface NearHANodesStackProps extends cdk.StackProps {
    instanceType: ec2.InstanceType;
    instanceCpuType: ec2.AmazonLinuxCpuType;
    nearCluster: configTypes.NearCluster;
    nearVersion: string;
    nodeConfiguration: configTypes.NearNodeConfiguration;
    dataVolume: configTypes.NearDataVolumeConfig;
    accountsVolume: configTypes.NearAccountsVolumeConfig;
...
export class NearHANodesStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: NearHANodesStackProps) {
        ...
        const modifiedInitNodeScript = cdk.Fn.sub(nodeScript, {
            ...
            _NEAR_NODE_TYPE_: nodeConfiguration,
            _NEAR_NODE_IDENTITY_SECRET_ARN_: constants.NoneValue,
            _NEAR_CLUSTER_: nearCluster,
