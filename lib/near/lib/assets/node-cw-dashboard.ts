    ...
    "widgets": [
        ...
        },
        {
            ...
            "properties": {
                ...
                "period": 60,
                "metrics": [
                    [ "CWAgent", "near_slots_behind", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "title": "Near Slots Behind"
            }
        },
        {
            "height": 5,
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    [ "CWAgent", "disk_used_percent", "InstanceId", "${INSTANCE_ID}", "device", "nvme1n1", "path", "/var/near/data", "fstype", "xfs", { "region": "${REGION}", "label": "/home/ubuntu/l2geth-source/l2geth-datadir" } ]
                ],
                "sparkline": true,
                "view": "singleValue",
                "region": "${REGION}",
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    [ "CWAgent", "disk_used_percent", "InstanceId", "${INSTANCE_ID}", "device", "nvme2n1",  "path", "/var/near/accounts", "fstype", "xfs", { "region": "${REGION}", "label": "/home/ubuntu/l2geth-source/l2geth-datadir" } ]
                ],
                "sparkline": true,
                "view": "singleValue",
                "region": "${REGION}",
