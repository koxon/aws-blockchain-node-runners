...
export class NearSingleNodeStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: NearSingleNodeStackProps) {
        ...
        const modifiedInitNodeScript = cdk.Fn.sub(nodeStartScript, {
            ...
            _NEAR_NODE_IDENTITY_SECRET_ARN_: nearNodeSecretARN,
        ...
        new cw.CfnDashboard(this, 'near-cw-dashboard', {
