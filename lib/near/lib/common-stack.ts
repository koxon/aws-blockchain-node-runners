...
export class NearCommonStack extends cdk.Stack {
    ...
    constructor(scope: cdkConstructs.Construct, id: string, props: NearCommonStackProps) {
        ...
        instanceRole.addToPolicy(new iam.PolicyStatement({
           resources: [`arn:aws:autoscaling:${region}:${this.AWS_ACCOUNT_ID}:autoScalingGroup:*:autoScalingGroupName/near-*`],
